        ...
        <div class="container">
          <div class="row slide-margin">
            ...
            <h1 class="animation animated-item-1" style="padding-bottom:10px;">REGISTER HERE</h1>
              ...
              <ul>
                <li><a href="registrationFormTrainee.fssai"><img src="website/images/trainee.png"></a></li>
...
<table width="100%" border="0" cellpadding="10" cellspacing="10" class="table-border">
  ...
  <tr>
    <td class="td-border" align="center"><p>Basics of Food Safety</p></td>
    <td class="td-border"><p></p></td>
    <td class="td-border" align="center"><p>2 hrs</p></td>
    <td class="td-border" align="center"><p>Any Individual</p></td>
    <td class="td-border"><p>General food hygiene and safety practices for safe food handling ;How to read label ;Sensitization on food</p></td>
   </tr>  
</table>
</div>
   </div>
