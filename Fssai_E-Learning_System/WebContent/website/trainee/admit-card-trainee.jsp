...
<!--         <li>GHP-GMP-HACCP</li> -->
  ...
  <tr>
    <td><table width="100%" border="0" style="border-top: 1px solid #CCC;">
        ...
        <tr>
          <td align="center" style="border-top: 1px solid #CCC; border-right: 1px solid #CCC; padding:10px; font-family:Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:14px; font-weight:bold;"><img src="${pageContext.request.contextPath}/website/img/authorize-signature.png" width="58" height="30"  alt=""/><br>
            <strong>Authorize Signatory</strong></td>
        </tr>
      </table></td>
    <td align="center" style="border-top: 1px solid #CCC; padding:10px; font-family:Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:14px; font-weight:bold;"><table width="100%" border="0">
        <tr>
          <td width="61%" align="center"><img src="${imagePath}" width="76" height="93"  alt=""/><br>
        ...
        <div align-items: center> <input type="button" value="Download AdmitCard" id="btnPrint" />  </div>
          <div class="col-md-4 col-xs-12"></div>
        </div>
