                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table width="100%" border="0" style="border-top: 1px solid #CCC;">
                                                                ...
                                                                <tr>
                                                                    <td align="center" style="border-top: 1px solid #CCC;border-right: 1px solid #CCC;padding: 10px;font-family:Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:14px;font-weight:bold;position: relative;top: -1em;border-bottom: 1px solid #ccc;padding-top: 5em;"><img src="/Fssai_E-Learning_System/website/img/authorize-signature.png" width="58" height="30" alt="" />
                                                                        <br>
