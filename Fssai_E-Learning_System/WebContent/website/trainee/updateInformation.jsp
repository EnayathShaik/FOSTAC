...
function getStateUpdate(cs,cd,cc)
{
	$.ajax({
	      ...
	      $('#correspondenceState').append('<option value="0" label="Select Stateeeeee" />');
	  	  
	      $.each(mainData2 , function(i , obj)
	  		{	
	    	  if(cs == obj.stateId){
	    		  $('#correspondenceState').append('<option value='+obj.stateId+' label='+obj.stateName+' selected="true" />');	
	    	  }else{
	    		  $('#correspondenceState').append('<option value='+obj.stateId+' label='+obj.stateName+' />');	
	    	  }	
	  		});
	      }
	      });
	...
	$.ajax({
	      ...
	      $.each(mainData1 , function(i , obj)
	    	  ...
	    	  if(cd == obj.districtId){
	    		  $('#correspondenceDistrict').append('<option value='+obj.districtId+' label='+obj.districtName+' selected="true"/>');
	    	  }else{
	    		  $('#correspondenceDistrict').append('<option value='+obj.districtId+' label='+obj.districtName+' />');
	    	  }	
	  		});
...
function getCityUpdate(cd , cc)
{
	$.ajax({
	      ...
	      $.each(mainData1 , function(i , obj)
	  		{
	    	  if(cc == obj.cityId){
	    		  $('#correspondenceCity').append('<option value='+obj.cityId+' label='+obj.cityName+' selected="true"/>');
	    	  }else{
	    		  $('#correspondenceCity').append('<option value='+obj.cityId+' label='+obj.cityName+' />');
	    	  }	
	  		});
...
function getStateUpdateP(ps, pd , pc)
{
	$.ajax({
	      ...
	      $('#resState').append('<option value="0" label="Select State" />');
	  	  
	      $.each(mainData2 , function(i , obj)
	  		{	
	    	  if(ps == obj.stateId){
	    		  $('#resState').append('<option value='+obj.stateId+' label='+obj.stateName+' selected="true" />');	
	    	  }else{
	    		  $('#resState').append('<option value='+obj.stateId+' label='+obj.stateName+' />');	
	    	  }	
	  		});
	      }
	      });
	...
	$.ajax({
	      ...
	      $.each(mainData1 , function(i , obj)
	    	  ...
	    	  if(pd == obj.districtId){
	    		  $('#bussDistrict').append('<option value='+obj.districtId+' label='+obj.districtName+' selected="true"/>');
	    	  }else{
	    		  $('#bussDistrict').append('<option value='+obj.districtId+' label='+obj.districtName+' />');
	    	  }	
	  		});
...
function getCityUpdateP(pd , pc)
{
	...
	$.ajax({
	      ...
	      var mainData1 = jQuery.parseJSON(response);
	      $('#resCity option').remove();
	      $('#resCity').append('<option value="0" label="Select District" />');
	  	  
	      $.each(mainData1 , function(i , obj)
	  		{
	    	  if(pc == obj.cityId){
	    		  $('#resCity').append('<option value='+obj.cityId+' label='+obj.cityName+' selected="true"/>');
	    	  }else{
	    		  $('#resCity').append('<option value='+obj.cityId+' label='+obj.cityName+' />');
	    	  }	
	  		});
...
function getStateUpdateB(bs , bd , bc)
{
	$.ajax({
	      ...
	      $('#bussState').append('<option value="0" label="Select State" />');
	  	  
	      $.each(mainData2 , function(i , obj)
	  		{	
	    	  if(bs == obj.stateId){
	    		  $('#bussState').append('<option value='+obj.stateId+' label='+obj.stateName+' selected="true" />');	
	    	  }else{
	    		  $('#bussState').append('<option value='+obj.stateId+' label='+obj.stateName+' />');	
	    	  }	
	  		});
	      }
	      });
	...
	$.ajax({
	      ...
	      $.each(mainData1 , function(i , obj)
	    	  ...
	    	  if(bd == obj.districtId){
	    		  $('#residentialDistrict').append('<option value='+obj.districtId+' label='+obj.districtName+' selected="true"/>');
	    	  }else{
	    		  $('#residentialDistrict').append('<option value='+obj.districtId+' label='+obj.districtName+' />');
	    	  }	
	  		});
...
function getCityUpdateB(bd , bc)
{
	$.ajax({
	      ...
	      var mainData1 = jQuery.parseJSON(response);
	      $('#bussCity option').remove();
	      $('#bussCity').append('<option value="0" label="Select District" />');
	  	  
	      $.each(mainData1 , function(i , obj)
	  		{
	    	  if(bc == obj.cityId){
	    		  $('#bussCity').append('<option value='+obj.cityId+' label='+obj.cityName+' selected="true"/>');
	    	  }else{
	    		  $('#bussCity').append('<option value='+obj.cityId+' label='+obj.cityName+' />');
	    	  }	
	  		});
      ...
      <div id="page-content-wrapper">
        <div class="container-fluid"> 
          ...
          <div class="row">
            ...
            <span style="font-size:14px;">Welcome Trainee</span>
            </i> </a> </div>
          </div>
                  ...
                  <fieldset >
                    ...
                    <div class="col-md-6 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Aadhar Number"  disabled="disabled"   value=" ${loginUser.aadharNumber}">
                      </div>
                      <div class="form-group">
                        <div>
                          <ul class="lab-no">
                        ...
                        <input type="text" class="form-control" placeholder="Date"  disabled="disabled"    value="${loginUser.dob }">
                      </div>
<div class="form-group">
<div>
<ul class="lab-no">
...
<%-- <cf:options items="${titleList}" itemValue="titleId" itemLabel="titleName" /> --%>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="First Name" disabled="disabled"  value="${loginUser.firstName }">
                      </div>
                      <div class="form-group">
                        <div>
                          <ul class="lab-no">
                        ...
                        <input type="text" class="form-control" placeholder="Middle Name" disabled="disabled"  value="${loginUser.middleName }">
                      </div>
                      <div class="form-group">
                        <div>
                          <ul class="lab-no">
                        ...
                        <input type="text" class="form-control" placeholder="Last Name" disabled="disabled"  value="${loginUser.lastName }">
                      </div>
                    </div>
                  </fieldset>
                </div>
...
<cf:input path="correspondenceAddress1" class="form-control"  placeholder="Address "  value="${loginUser.correspondenceAddress1}"  maxlength="100" />
</div>
...
<cf:input path="correspondenceAddress2" class="form-control"  placeholder="Address 2"  value="${loginUser.correspondenceAddress2}" maxlength="100"/>
</div>                     
...
<cf:options items="${stateList}" itemValue="stateId" itemLabel="stateName"/>
                      ...
                      <div class="form-group">
                       ...
                       <cf:input id="Email" path="Email" placeholder="Email" class="form-control" value="${loginUser.email}" type="text" />
...
<div class="form-group">
                       ...
                       <input id="mobile" name="mobile" placeholder="Mobile" class="form-control" value="${loginUser.mobile}" type="text"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" maxlength="10">
...
<cf:input path="ResidentialAddressLine1" placeholder="Residential Address Line 2" class="form-control" value="${loginUser.residentialLine1 }" maxlength="100"/>
</div> 
...
<cf:input path="ResidentialAddressLine2"  value="${loginUser.residentialLine2}" placeholder="Residential Address Line 2" class="form-control" maxlength="100"/>
</div> 
...
<cf:options items="${cityList}" itemValue="cityId" itemLabel="cityName" />
                      ...
                      <div class="form-group">
						...
						<cf:input id="resPincode" path="resPincode" class="form-control" placeholder="Pin Code" value="${loginUser.resPincode}"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" maxlength="6" />
                      </div>
                    </div>
                    <!--Right side-->
              ...
              <div class="form-group">
                <div>
                  <ul class="lab-no">
                    <li class="style-li"><strong>Select Kind of Business:</strong></li>
                  </ul>
                </div>                
	...
	<cf:options items="${kindOfBusinessList}" itemValue="kindOfBusinessId" itemLabel="kindOfBusinessName" />
              ...
              <div class="form-group">
                <div>
                  <ul class="lab-no">
                    <li class="style-li"><strong>Designation:</strong> <a href="#myModal" data-toggle="modal" data-target="#myModal">Do you want?</a></li>
                  </ul>
                </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <table align="center" width="200" border="0" class="table table-bordered table-responsive table-hover table-striped">
                          <thead>
                          <tr><th bgcolor="#0033CC" style="color:#fff;">Designation</th>
            ...
            <div class="col-md-6 col-xs-12">
              <div class="form-group">
                ...
                <cf:input id="CompanyName" path="CompanyName" class="form-control" placeholder="Company Name" required="" value="${loginUser.companyName}" maxlength="50"/>
              </div>
              <div class="form-group">
                <div>
                  <ul class="lab-no">
                    <li class="style-li"><strong>Registration Number:</strong></li>
                  </ul>
                </div>
                <cf:input id="registrationNo" path="registrationNo" value="${loginUser.registrationNo }" class="form-control" placeholder="Number" maxlength="50" />
              </div>          
...
<cf:input path="BusinessAddressLine1" class="form-control"  placeholder="Business Address Line 1" value="${loginUser.businessAddressLine1}" maxlength="100"/>
</div>
...
<cf:input path="BusinessAddressLine2" class="form-control"  placeholder="Business Address Line 2"  value="${loginUser.businessAddressLine2}" maxlength="100"/>
</div>
...
<cf:options items="${stateList}" itemValue="stateId" itemLabel="StateName" />
                    ...
                    <div class="form-group">
                        ...
                        <select id="bussDistrict" name="bussDistrict" class="form-control" onchange="getCity2(this.value);">
<option value="0" selected="selected">Select District</option>
                      ...
                      <div class="form-group">
                       ...
                       <!--  <select class="form-control" >
                        ...
                        <cf:select path="bussCity" id="bussCity" class="form-control">
<cf:option value="0" label="Select City" />
<cf:options items="${cityList}" itemValue="cityId" itemLabel="cityName" />
</cf:select>
                      </div>
...
<cf:input path="bussPincode" class="form-control"  value="${loginUser.bussPincode}"  placeholder="Pincode" maxlength="6" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" />
                ...
                <form>
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="col-xs-4">
                      <div class="form-group"> 
                        <input type="submit" class="form-control login-btn" value="Update" onsubmit=   />
                        </div>
                    </div>
                    <div class="col-xs-4"></div>
                  </div>
