...
<cf:input path="UserId" onkeypress="return AvoidSpace(event)" onKeyUP="this.value = this.value.toUpperCase();" class="form-control"  placeholder="User Id"  onblur  ="checkname();"/>
</div>
<div class="form-group">
<div>
<ul class="lab-no">
...
<cf:input path="AssessorCorrespondenceLine1" maxlength="100" class="form-control"  placeholder="Address Line 1"/>
</div> 
...
<cf:input path="AssessorCorrespondenceLine2" maxlength="100" class="form-control"  placeholder="Address Line 1"/>
</div>
...
<cf:input path="AssessorPermanentLine1" maxlength="100" placeholder="Address Line 1" class="form-control" />
</div> 
...
<cf:input path="AssessorPermanentLine2" maxlength="100" placeholder="Address Line 2" class="form-control" />
</div> 
...
<ct:if test="${not empty basicCourseList }">
 ...
 <label> <input type="checkbox"  value="${listValue[2] }" name="basicCourses"  id="${listValue[2] }"  onclick=" return myBasic();">${listValue[1]}</label><br>
 </ct:if>
 </ct:forEach>
</ct:if>
