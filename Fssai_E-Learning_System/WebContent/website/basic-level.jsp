        ...
        <div class="container wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12">
                    ...
                    <div id="accordion">
                        <h3>GHP-GMP* Certification Course</h3>
                        <div>
                            ...
                            <div class="tab-content">
                                <div id="course" class="tab-pane fade in active">
                                    <ul id="video">
                                        <li class="fsize">GHP-GMP* Certification Course</li>
                                    </ul>
                                </div>
                                ...
                                <div id="who" class="tab-pane fade">
                                    <ul id="video">
                                        <li class="fsize">Street Food Vendors</li>
                                        <li class="fsize">Small Restaurants</li>
                                        <li class="fsize">Small manufacturer (cottage industry)</li>
                                    </ul>
                                </div>
