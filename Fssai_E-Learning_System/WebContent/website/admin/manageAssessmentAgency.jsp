...
<script type="text/javascript">
	function validate() {
		...
		if (userID == "" || userID.length <= 0) {
			...
			status = false;
		} else if (assAgencyName == ""
				|| assAgencyName.length <= 0) {
...
<script type="text/javascript" language="javascript">
	...
	function searchData() {
		var userId = $("#userId").val();
		var aan = $("#assessmentAgencyName").val();
												...
												$('#newTable')
														.append(
																'<tr id="tableRow"><td>'
																		...
																		+ '</td><td>'
																		+ obj[4]
																		+ '</td><td><input type="hidden" id="maaId'+i+'" value="'+obj[0]+'" /><a href="#" onClick="editManageAssessmentAgency('
																		+ i
																		+ ');">edit</a><input type="hidden" id="sid" value="'+obj[13]+'"><input type="hidden" id="sid" value="'+obj[14]+'"> <input type="hidden" id="sid" value="'+obj[15]+'"></td></tr>');
											});
						}
					});
			$('#newTable').show();
...
<script>
	function updateData() {
		...
		var total = "userId=" + userId + "&status=" + status + "&websiteUrl="
				+ websiteUrl + "&email=" + email + "&headOfficeDataAddress1="
				+ headOfficeDataAddress1 + "&headOfficeDataAddress2="
				+ headOfficeDataAddress1 + "&pin=" + pin + "&stateId="
				+ stateId + "&district=" + district + "&city=" + city;
		$(".displayNone").css("display", "block");
		$("#updateDiv").hide();
		$("#createDiv").show();
		$.ajax({
...
<cf:form action="manageAssessmentAgencySave.fssai" name="myForm"
	method="POST" commandName="manageAssessmentAgencyForm"
							...
							<div id="navbar" class="navbar-collapse collapse">
								<ul class="nav navbar-nav">
									...
									<li><a href="#" class="dropdown-toggle"
										...
										<ul class="dropdown-menu">
											<li><a href="traineeUserManagementForm.fssai"
												class="clr">Trainee</a></li>
											<li><a href="trainerUserManagementForm.fssai"
												class="clr">Trainer</a></li>
											<li><a href="trainingCenterUserManagementForm.fssai"
												class="clr">Training Center</a></li>
											<li><a href="assessorUserManagementForm.fssai"
												class="clr">Assessor</a></li>
									...
									<li><a href="#" class="dropdown-toggle"
										...
										<ul class="dropdown-menu">
											...
											<li><a href="regioMappingMaster.fssai" class="clr">Region
													Mapping</a></li>
										</ul></li>
									<li><a href="manageTrainingPartnerForm.fssai">Manage
											Training Partner</a></li>
									<li class="active"><a
										href="manageAssessmentAgencyForm.fssai">Manage Assessment
											Agency</a></li>
								</ul>
								<ul class="nav navbar-nav navbar-right">
									<li class="dropdown active"><a href="#"
										...
										<ul class="dropdown-menu">
											<li><a href="changePasswordAssesAgency.fssai">Change
													Password</a></li>
				...
				<div id="sidebar-wrapper">
					<ul class="sidebar-nav">
						...
						<li><a href="manageCourseContent.fssai">Manage Course
								Content</a></li>
						<li><a href="trainingCalendarForm.fssai">Training
								Calendar</a></li>
						<li><a href="assessmentSchedule.fssai">Update Assessor</a></li>
						<li><a href="manageAssessmentQuestions.fssai">Assessment
								Questions</a></li>
						<li><a href="updateTrainerAssessment.fssai">TOT
								Assessment</a></li>
						<li><a href="feedback-master.html">Feedback Master</a></li>
					</ul>
				</div>
				<!-- /#sidebar-wrapper -->
				<!-- Page Content -->
									...
									<div class="col-xs-12">
										...
										<div class="col-xs-6">
											<div class="form-group">
												<div>
													<ul class="lab-no">
														...
														<li class="style-li error-red">${created } <span
															id="name_status"> </span> <cf:errors path="userId"
																cssClass="error" />
														</li>
													</ul>
												</div>
												...
												<div>
													<ul class="lab-no">
														...
														<li class="style-li error-red"><cf:errors
																path="assessmentAgencyName" cssClass="error" /></li>
													</ul>
												</div>
												<cf:input path="assessmentAgencyName"
													placeholder="Assessment Agency Name" class="form-control" />
											</div>
											...
											<div class="form-group">
												...
												<cf:input path="websiteUrl" placeholder="Website URL"
													class="form-control" />
											</div>
											...
											<div class="form-group">
												<div>
													<ul class="lab-no">
														...
														</span> <cf:errors path="PAN" cssClass="error" /></li>
													</ul>
												</div>
												<cf:input path="PAN" placeholder="PAN" class="form-control"
													onKeyUP="this.value = this.value.toUpperCase();"
													onblur="pan_validate(this.value);" />
											</div>
								...
								<fieldset>
									...
									<div class="col-md-6 col-xs-12">
										<div class="form-group">
											...
											<cf:input path="headOfficeDataAddress1" placeholder="Address"
												class="form-control" />
										</div>
										<div class="form-group">
											<div>
											...
											<cf:input path="headOfficeDataAddress2" placeholder="Address"
												class="form-control" />
										</div>
										<div class="form-group">
											<div>
											...
											<cf:input path="pin"
												...
												placeholder="PIN" class="form-control" maxlength="6" />
										</div>
									</div>
									<!-- right side -->
									<div class="col-md-6 col-xs-12">
								...
								<div class="col-md-6 col-xs-12" style="margin-top: 26px;">
									...
									<div id="createDiv" style="float: left;">
										<input type="submit" id="register"
											onclick="return validate();" class="btn login-btn"
											value="Create" />
									</div>
									<div id="updateDiv" style="float: left; margin-left: 20px;">
										<a href="#" onclick="updateData();"
											class="btn btn-default pull-right show-details-vacancy collapsed"
											data-toggle="collapse" data-target="#show-result"
											aria-expanded="false" style="margin-right: 0px;"> Update</a>
									</div>
									<div id="searchDiv" style="float: left; margin-left: 20px;">
										<a href="#" onclick="searchData();"
											class="btn btn-default pull-right show-details-vacancy collapsed"
											data-toggle="collapse" data-target="#show-result"
											aria-expanded="false" style="margin-right: 15px;"> Search</a>
									</div>
