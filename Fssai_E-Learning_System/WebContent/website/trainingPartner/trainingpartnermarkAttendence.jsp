...
function showDetails(indicator){
		...
		var result="";
			...
			{
				if(obj[7] == 'A'){
					$('#newTable').append('<tr id="tableRow"><td>'+j+'</td><td>'+obj[0]+'</td><td>'+obj[1]+'</td><td>'+obj[2]+'</td><td>'+obj[3]+'</td><td>'+obj[4]+'</td><td><input type="hidden" value='+obj[5]+' name="validAadhar" id="validAadhar" /><input path="AadharNumber" id="AadharNumber" name="AadharNumber" class="form-control" maxlength="12" disabled="disabled" placeholder="Aadhar Number" onblur=ck_aadhar(this); /></td><td><select style="width:100px;height:34px;font-size:12px;" disabled="disabled" name =attendanceRow'+j+'  id=attendanceRow'+j+'><option selected="true" name="present" value ="A">Present</option><option name="absent" value="I">Absent</option></td><td><button onclick="updateAttendance('+obj[6]+' , '+j+');return false;">Update</button></td></tr>');
				}else if(obj[7] == 'I'){
					$('#newTable').append('<tr id="tableRow"><td>'+j+'</td><td>'+obj[0]+'</td><td>'+obj[1]+'</td><td>'+obj[2]+'</td><td>'+obj[3]+'</td><td>'+obj[4]+'</td><td><input type="hidden" value='+obj[5]+' name="validAadhar" id="validAadhar" /><input path="AadharNumber" id="AadharNumber" name="AadharNumber" class="form-control" maxlength="12" placeholder="Aadhar Number" onblur=ck_aadhar(this); /></td><td><select style="width:100px;height:34px;font-size:12px;" disabled="disabled" name =attendanceRow'+j+'  id=attendanceRow'+j+'><option name="present" value ="A">Present</option><option selected="true" name="absent" value="I">Absent</option></td><td><button onclick="updateAttendance('+obj[6]+' , '+j+');return false;">Update</button></td></tr>');
				}else{
					$('#newTable').append('<tr id="tableRow"><td>'+j+'</td><td>'+obj[0]+'</td><td>'+obj[1]+'</td><td>'+obj[2]+'</td><td>'+obj[3]+'</td><td>'+obj[4]+'</td><td><input type="hidden" value='+obj[5]+' name="validAadhar" id="validAadhar" /><input path="AadharNumber" id="AadharNumber" name="AadharNumber" class="form-control" maxlength="12" placeholder="Aadhar Number" onblur=ck_aadhar(this); /></td><td><select style="width:100px;height:34px;font-size:12px;" disabled="disabled" name =attendanceRow'+j+'  id=attendanceRow'+j+'><option name="present" value ="A">Present</option><option name="absent" value="I">Absent</option></td><td><button onclick="updateAttendance('+obj[6]+' , '+j+');return false;">Update</button></td></tr>');
				}
