                        ...
                        <div class="container-fluid">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        <fieldset>
                                        <legend><h3>Manage Trainer</h3></legend>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                     <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="selTrainerName" id = "selTrainerName"> </select>
														<script>
															var selectTrainerOptions = "";
															for(var i=0 ; i < trainerList.length; i++)
																{
																	console.log(trainerList[i].CourseTypeId + " -- "+ trainerList[i].CourseType);
																	selectTrainerOptions += "<option value="+trainerList[i].id+">"+trainerList[i].value+"</option>"
																	
																}
															document.getElementById('selTrainerName').innerHTML += selectTrainerOptions; 
														</script>
