                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="hori active"><a href="update-personal-information.html">Update Personal Information</a></li>
            ...
            <section class="main-section-margin-top">
                <div class="container-fluid">
                    <div id="wrapper">
                      ...
                      <li> <a href="update-result.html">Update Result</a> </li>
                    </ul>
                        </div>
                        <!-- /#sidebar-wrapper -->
                        <!-- Page Content -->
...
<cf:options items="${assessmentAgencyNameList}" itemValue="manageAssessmentAgencyId" itemLabel="assessmentAgencyName" />
                        ...
                        <div class="personel-info">
         <fieldset>
              <legend><h3>Correspondence Address</h3></legend>              
              <!-- permanent address -->
            <!--Left side-->
              <div class="col-md-6 col-xs-12">
                <div class="form-group">
                  ...
                  <label>
                    ...
                    and the Privacy Policy of FSSAI. </a> --> </label>
                        ...
                        <div class="col-md-4 col-xs-12">
                            <a href="login.html"><input type="submit" class="form-control login-btn" value="Update" onclick="return ValidCaptcha();"></a>
                        </div>
