      ...
      <div class="row slide-margin">
        ...
        <div class="circle-wrap center-block">
              <ul>
                ...
                <li><a href="training-partner.fssai"><img src="website/images/training-partner.png"></a></li>
    ...
    <div class="row">
      <div class="features">
        <div class="col-md-3 col-sm-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
          <div class="feature-wrap"> <a href="free-food-safety-certification.fssai"><img class="img-responsive center-block" src="website/images/fssai-certification-logo.jpg" width="132" height="87"></a>
            <h3><a href="free-food-safety-certification.fssai">Free Training on<br>
              Food Safety</a></h3>
          </div>
        </div>
        <!--/.col-md-4-->
...
<section id="study">
  <div class="row">
    <div class="col-md-12 col-sm-12 pull-left">
      <h1 style="padding-right:216px; border-bottom:1px #0b0c84 solid; padding-bottom:10px;">FoSTaC- Food Safety Training & Certification</h1>
    </div>
  </div>
  <div class="row">
