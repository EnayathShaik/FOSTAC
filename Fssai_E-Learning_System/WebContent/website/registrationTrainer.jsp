...
<cf:input path="UserId" onkeypress="return AvoidSpace(event)" class="form-control" onKeyUP="this.value = this.value.toUpperCase();"  placeholder="User Id"  onblur  ="checkname();"/>
</div>
...
<li class="style-li error-red">
<label id="DOBError" class="error visibility">* select your date of birth</label>
...
<li class="style-li error-red">
<label id="fatherNameError" class="error visibility">* error </label>
...
<cf:input path="TrainingCenterCorrespondenceLine1" class="form-control" maxlength="100"  placeholder="Address Line 1"/>
</div> 
...
<cf:input path="TrainingCenterCorrespondenceLine2" class="form-control" maxlength="100" placeholder="Address Line 2"/>
</div>
...
<cf:checkbox id="checkPermanent" path="checkPermanent" onclick="myCheckPermanent(this)"/> <label class = "error">Is your correspondence address same as permanent address.</label> 
</div>
...
<cf:input path="TrainingCenterPermanentLine1" maxlength="100" placeholder="Address Line 1" class="form-control" />
</div> 
...
<cf:input path="TrainingCenterPermanentLine2" maxlength="100" placeholder="Address Line 2" class="form-control" />
</div> 
...
<div class="row">
<div class="col-xs-6">
<cf:input class="form-control" place-holder="Years" path="ExpInFoodSafefyTimeYear" maxlength="2" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"/>
</div>
<div class="col-xs-6">
...
<label class="radio-inline">
<cf:radiobutton path="AssociatedWithAnyTrainingPartner" id="AssociatedWithAnyTrainingPartner" value="Y" onclick="disableTPName(this.value);" checked="true" />Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
<cf:radiobutton path="AssociatedWithAnyTrainingPartner" value="N" onclick="disableTPName(this.value);"/>No</td>
</label>
