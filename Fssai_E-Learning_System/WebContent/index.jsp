...
<body class="homepage">
						...
						<div class="social">
							<div class="social-share">
								<a href="#" target="_blank"><img class="img-responsive"
									src="website/images/fssai-logo.jpg"></a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="row slide-margin">
							<div class="col-sm-12">
								<div class="carousel-content">
									<h1 class="animation animated-item-1">Food Safety Training
							...
							<div class="col-xs-12" style="right: 93px;">
								...
								<div class="col-md-3 xs-hidden">
									<a href="trainingpartner.fssai"><img
					...
					<div class="col-md-3 col-sm-4 wow fadeInDown"
						...
						<div class="feature-wrap">
							<a href="commonCourses.fssai?id=8"><img
								...
								height="87"></a>
							<h3>
								<a href="commonCourses.fssai?id=8">Awareness on <br>
									Food Safety
								</a>
							</h3>
						</div>
					...
					<div class="col-md-3 col-sm-4 wow fadeInDown"
						...
						<div class="feature-wrap feature-wrapbasic">
							<a href="commonCourses.fssai?id=5"><img
								...
								height="87"></a>
							<h3>
								<a href="commonCourses.fssai?id=5">Basic Food Safety <br>
									Certification
								</a>
							</h3>
						</div>
					...
					<div class="col-md-3 col-sm-4 wow fadeInDown"
						...
						<div class="feature-wrap feature-wrapadvance">
							<a href="commonCourses.fssai?id=6"><img
								...
								height="87"></a>
							<h3>
								<a href="commonCourses.fssai?id=6">Advance Food Safety <br>
									Certification
								</a>
							</h3>
						</div>
					...
					<div class="col-md-3 col-sm-4 wow fadeInDown"
						...
						<div class="feature-wrap">
							<a href="commonCourses.fssai?id=7"><img
								...
								height="87"></a>
							<h3>
								<a href="commonCourses.fssai?id=7">Special Food Safety <br>
									Certification
								</a>
							</h3>
						</div>
					...
					<div class="col-md-3 col-sm-4 wow fadeInDown"
						...
						<div class="feature-wrap course-bg">
							...
							<h3 class="industry-heading">
								<a href="commonCourses.fssai?id=1">Catering</a>
							</h3>
							<!-- <ul>
					...
					<div class="col-md-3 col-sm-4 wow fadeInDown"
						...
						<div class="feature-wrap course-bg">
							<img class="img-responsive center-block"
								...
								height="94">
							<h3 class="industry-heading">
								<a href="commonCourses.fssai?id=2">Manufacturing</a>
							</h3>
							<!-- <ul>
                                            <li><a href="basic-level.fssai">Basic Level</a></li>
                                            <li><a href="advance-level.fssai">Advance Level</a></li>
						...
						<a href="knowYourTrainingPartner.fssai">
							<div class="feature-wrap partner-box center-block">
								<h3 class="box-heading">TRAINING PARTNER & ASSESSMENT
									AGENCY</h3>
								<p>View the list of Training Partner to select as per
									requirement.</p>
							</div>
						</a>
					</div>
					...
					<div class="col-md-3 col-sm-4 wow fadeInDown"
						...
						<div class="feature-wrap training-box center-block">
							...
							<div style="margin: 10px 0px 0px 0px;">
								...
								<input type="text" value="" id="zip" style="width: 150px;"
									placeholder="Enter Pincode" />
								<button onclick="getCenterAddress();return false;">Submit</button>
								<span id="centerAdd"> <span id="centerName"></span> <br>
									<span id="lane1"></span> <span id="lane2"></span> <span
									id="city"></span> <span id="state"></span>
								</span>
							</div>
						</div>
					</div>
	...
	<script src="website/js/jquery.modal.js" type="text/javascript"
...
<div id="ex1" style="display: none;">
	<p id="batchInfo">
		Thanks for clicking. That felt good. <a href="#" rel="modal:close">Close</a>
		or press ESC
	</p>
</div>
